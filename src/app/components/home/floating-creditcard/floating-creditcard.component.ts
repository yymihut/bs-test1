...
@Component({
  selector: 'app-floating-creditcard',
  templateUrl: './floating-creditcard.component.html',
  styleUrls: ['./floating-creditcard.component.css']
})
export class FloatingCreditcardComponent implements OnInit{
